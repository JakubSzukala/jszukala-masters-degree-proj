...
def detection_results_to_classification_results(gt, preds, device):
    ...
    # This fixes error: "IndexError: too many indices for tensor of dimension 1" that sometimes
    # occurs when list is used as index
    preds_match_idices = torch.tensor(preds_match_idices, device=device)
