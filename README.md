...
8. Reinforcement learning algorithm that would control a camera while live spectating a game like Star Craft 2
    ...
    * To control the camera we would probably have to use C++ API from Blizzard, not Python wrapper from Deepmind, unless we could write a handle / wrapper to use [ObserverActionINterface class](https://blizzard.github.io/s2client-api/classsc2_1_1_observer_action_interface.html) from Python
